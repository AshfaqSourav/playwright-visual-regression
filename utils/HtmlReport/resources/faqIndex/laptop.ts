// /utils/HtmlReport/generatefaqIndexDesktopHtmlReport.ts
...
<head>
  ...
  <style>
    body { margin: 0; padding: 0; font-faqIndex: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f5f5f5; color: #333; }
