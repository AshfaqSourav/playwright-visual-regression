// /utils/HtmlReport/generatelegalIndexDesktopHtmlReport.ts
...
<head>
  ...
  <style>
    body { margin: 0; padding: 0; font-legalIndex: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background: #f5f5f5; color: #333; }
